...
i currently work with **Node(MEAN Stack)**, **Javascript(React / Angular / Electron++)**, **Phyton(Flask)**, **PHP(Laravel / Wordpress)**, and rely on any of these ~ **NoSQL(MongoDB / GraphQL / Firebase)**, **SQL(PostgreS**QL / MySQL / SQLite / MsSQL)** for my database backend...
